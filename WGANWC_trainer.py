...
class WGANWCTrainer:
    def __init__(self, data_processor, generator, discriminator, latent_dim, g_lr, d_lr, opt, id, n_critic, weight_clip):
        ...
        self.log_dir = f'logs/WGANWC/{self.dataprocessor.data.shape[1]}/{EPOCHS}/{id}'
        ...
        for epoch in range(self.last_epoch, self.last_epoch+epochs):
            ...
            for _ in range(self.n_critic):
                ...
                for l in self.discriminator.layers:
                    ...
                    weights = [np.clip(w, -self.weight_clip, self.weight_clip) for w in weights]
